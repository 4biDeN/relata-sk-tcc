        ...
        <div class="frame">
            ...
            <q-card class="q-pa-lg card" flat bordered>
                ...
                <q-form @submit="onSubmit" greedy>
                    ...
                    <q-input v-model="form.user_email" type="email" label="E-mail" :rules="[req, emailRule]"
                    ...
                    <q-input v-model="form.user_password" :type="show ? 'text' : 'password'" label="Senha"
                        :rules="passwordRules" outlined>
                        <template #prepend><q-icon name="vpn_key" /></template>
                        <template #append>
                            <q-icon :name="show ? 'visibility_off' : 'visibility'" class="cursor-pointer"
                                @click="show = !show" />
                        </template>
                    </q-input>
